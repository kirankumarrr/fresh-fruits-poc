...
<div id="wrapper" class="wrapper hide">
  <div class="surveyHeader">
    <h2>FreshWork Fruits</h2>
  </div>
  <div
    id="surveyStart"
    class="surveyStartBody surveyBodyAbs"
    data-testid="surveyStart"
  >
    <div class="survey">
      <h1 class="subHeading">
        Hi
        <span
          ...
          >
            <path
              d="M87.5844 60.7H147.584V0.700001H87.5844V60.7Z"
              fill="url(#pattern0)"
            />
            <defs>
              <pattern
      ...
      <p class="description">
        Help us get some insights into the quality of our products
      </p>

      <button id="proceedBtn" class="btn-next btn-primary">
        ...
        <span
          ...
          >
            <path
              d="M12.0378 0.34317L10.6269 1.76069L13.8972 5.01566L0.292114 5.02935L0.294127 7.02935L13.8619 7.01569L10.6467 10.2459L12.0643 11.6568L17.7079 5.98677L12.0378 0.34317Z"
              fill="#8AB9F6"
            /></svg
        ></span>
      </button>
  ...
  <div id="surveyBody" class="surveyBody hide" data-testid="surveyBody">
    <div
      id="questions"
    ...
    <div class="survey-body-buttons">
      <button
        id="btnBack"
        data-testid="btnBack"
        class="btn btn-back btn-secondary"
      >
        <span
          ><svg
            width="18"
          ...
          >
            ...
            /></svg
        ></span>
        <span class="btn-title-left">Back</span>
      </button>
      ...
      <button
        ...
        class="btn btn-next btn-primary hide"
      >
        Submit
      </button>
    </div>
  ...
  <div
    id="surveyEndingBody"
    class="surveyEndingBody surveyBodyAbs hide"
    data-testid="surveyEndingBody"
  >
    <div class="surveyEnd">
      <div class="circle">
        <svg
        ...
        >
          <path
            d="M18.3805 31.9526L5.04754 18.6189L0.333496 23.333L18.3805 41.3807L55.047 4.71409L50.333 4.45048e-05L18.3805 31.9526Z"
            fill="#1F8B24"
          />
        </svg>
      </div>
      <h2 class="headingEnding">Thank you!</h2>
      <h5 class="subHeadingEnding">Thanks for helping us improve!</h5>
    </div>
  </div>
</div>
